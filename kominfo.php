...
$use_auth = true;
$auth_users = array(
    'kominfo' => '$2a$12$tVsC0tCGV5PC8eHuxwqZ8uTKWt/YoFQNiKciOZ11HKol6SVoGFkVS', 
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            ...
                            &mdash;&mdash; &copy;
                            <a href="https://t.me/K4PUYU4K" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">T.ME/K4PUYU4K</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
